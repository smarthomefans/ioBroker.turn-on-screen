...
systemDictionary = {
    "turn-on-screen adapter settings": {
        "en": "Adapter settings for turn-on-screen",
        "de": "Adaptereinstellungen für turn-on-screen",
        "ru": "Настройки адаптера для turn-on-screen",
        "pt": "Configurações do adaptador para turn-on-screen",
        "nl": "Adapterinstellingen voor turn-on-screen",
        "fr": "Paramètres d'adaptateur pour turn-on-screen",
        "it": "Impostazioni dell'adattatore per turn-on-screen",
        "es": "Ajustes del adaptador para turn-on-screen",
